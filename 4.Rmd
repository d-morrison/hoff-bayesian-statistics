...
```{r}
menchild30bach = scan(url('https://peterhoff.io/book/hwdata/menchild30bach.dat'))
menchild30nobach = scan(url('https://peterhoff.io/book/hwdata/menchild30nobach.dat'))
```
