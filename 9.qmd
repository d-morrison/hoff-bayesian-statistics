...
```{r}
swim = read.table(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/swim.dat'))
```
...
```{r}
crime = read.table(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/crime.dat'), header = TRUE)
```
