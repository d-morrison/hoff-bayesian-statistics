...
```{r}
Y_a <- scan(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/menchild30bach.dat'))
Y_b <- scan(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/menchild30nobach.dat'))
n_a = length(Y_a)
n_b = length(Y_b)
ybar_a = mean(Y_a)
ybar_b = mean(Y_b)
...
```{r}
glucose <- scan(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/glucose.dat'))
```
