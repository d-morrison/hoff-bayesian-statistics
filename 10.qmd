...
This section explores the idea of running multiple independent MCMC chains, then
combining the data (which is theoretically OK). In `icecore_parallel.R`, the approach is to take 
