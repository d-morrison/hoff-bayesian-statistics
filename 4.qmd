...
$\theta_i \sim p(\theta \mid y)$, are non-trivial -
for an example of algorithmically sampling from a Normal distribution
given just pseudo-random number generators,
see the [Box-Muller transform](http://www.math.nyu.edu/faculty/goodman/teaching/MonteCarlo2005/notes/GaussianSampling.pdf).
However,
