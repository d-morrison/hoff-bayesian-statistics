...
("a shortcut for thinking about full conditionals"); however, it should be mentioned that
...
same $\theta_j$ are expected to be closer together (due to decreased variability). The exact
