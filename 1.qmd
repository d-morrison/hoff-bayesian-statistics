...
probabilities using a Bayesian approach. An explanation of these proofs can be found in @vanhorn2003.
:::
...
probabilistically. Then, given data, these beliefs are rationally updated.

::: notes
There is a rich tradition in modeling human cognition using Bayesian methods to great
success, with plenty of work done in showing how people's beliefs and knowledge
about the world can be expressed probabilistically [e.g., @griffiths2006]
...
models are unfalsifiable. See @bowers2012, comment by @griffiths2012, reply by @bowers2012reply.
:::
