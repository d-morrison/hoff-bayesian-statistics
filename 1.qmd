...
probabilities using a Bayesian approach. An explanation of these proofs can be found at: http://ksvanhorn.com/bayes/Papers/rcox.pdf
...
about the world can be expressed probabilistically (e.g. [Griffiths & Tenenbaum, 2006](http://web.mit.edu/cocosci/archive/Papers/Griffiths-Tenenbaum-PsychSci06.pdf))
...
models are unfalsifiable. See [Bowers & Davis (2012)](https://psycnet.apa.org/journals/bul/138/3/389/), comment by [Griffiths, Chater, Norris, Pouget (2012)](https://cocosci.princeton.edu/tom/papers/LabPublications/HowBayesiansGetBeliefs.pdf), reply by [Bowers & Davis (2012)](https://pubmed.ncbi.nlm.nih.gov/22545688/).
...
introduced by [Tibshirani (1996)](https://www.jstor.org/stable/2346178) is also
