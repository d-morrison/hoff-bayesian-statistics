...
source("https://www2.stat.duke.edu/~pdh10/FCBS/Replication/chapter7.r")
# Try plotting
Y = Y.reading
...
```{r}
bluecrab = as.matrix(read.table(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/bluecrab.dat')))
orangecrab = as.matrix(read.table(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/orangecrab.dat')))
```
...
```{r}
agehw = as.matrix(read.table(url('https://www2.stat.duke.edu/~pdh10/FCBS/Exercises/agehw.dat')))
